    ...
    render() {
        ...
        return (
            ...
            <div className='top-like'>
              ...
              Твой результат ХХХ из ХХХ<br/>
              {(givePromocode) ?
              <span className='title_small'><span>Поздравляем! Лови</span>  промокод!</span> :
              <span className='title_small normal'>Неплохо, но недостаточно для получения промокода.</span>
            }
              </div> 
              {(givePromocode) ?
              <div>
              <div className='result__promocode'>
                 BG3200
              </div>
              <div className='result__attention'>
              Внимание! Промокод будет показан только 1 раз! Обязательно<br/> скопируй его или отправь себе на почту.
              </div>
              ...
              <img className='appstore' src={appstore}/><img className='googleplay' src={googleplay}/><br/><br/>
2. Или зайти на сайт <br/>
<img className='web' src={web}/><br/><br/>
3. Войти в свой аккаунт или зарегистрироваться на сервисе<br/>
...
Если возникли проблемы, пиши в нашу службу поддержки: <a href="mailto:help@tnt-premier.ru">help@tnt-premier.ru</a><br/>
 </div>
 <div className='rules'>
 * Промокод предоставляет 14 дней бесплатной подписки PREMIER на сервисе ТНT-PREMIER. Датой начала действия подписки считается дата активации промокода на сервисе ТНТ-PREMIER. Активировать промокод необходимо не позднее 31 декабря 2019 года.<br/>
<a href="">Подробнее о сервисе ТНТ-PREMIER и о подписке PREMIER можно прочитать тут.</a>
 ...
 <FontAwesomeIcon icon="igloo" />
              ...
              Не переживай, тебе обязательно<br/> повезет в следующий раз! А чтобы<br/> всегда быть в курсе наших акций,<br/> введи свой еmail в поле ниже.
              </div>
              <div className='button send-button' onClick={e => this.copyPromocode(e)}>
                Отправить
              </div>
              <div className='result__attention'>
              *Нажимая «Отправить» вы подтверждаете, что<br/> соглашаетесь получать на указанный еmail<br/> рекламную и другую информацию
              </div> 
              </div>
              }
            </div>
